function [Ind,Indx,Imat,unmatched_Indx]= match_vectors(longnum,shortnum)
...
%-------------------------------------------------------------------------------
% usage :	[Ind,Indx,Imat,unmatched_Indx] = match_dates(longnum,shortnum)
%-------------------------------------------------------------------------------
...
% [Ind,Indx,~,unmatched_Indx] = match_dates(dates5,datesxls);
%
