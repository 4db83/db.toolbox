function [varargout]= lstdi(data_with_dates,date_format,decimls,unts)
% -------------------------------------------------------------------------------------
% CALL AS: lstdi(data_with_dates,date_format,decimls,unts)
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
xout = [num2str((1:N)') repmat('			' ,N,1) datestr(x(:,1), date_format) repmat('    ',size(x,1),1) num2str(x(:,2:end),[prnt_format '  '])];
